...
namespace ChoQueVN.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        private string ImgURL(IFormFile img)
        {
            ...
            string _path = Path.Combine(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/Upload/ImageProducts", _fileName));
            //upload file
        ...
        private void RemoveImgURL(string _path)
        {
            if (_path != null && System.IO.File.Exists(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "Upload", "ImageProducts", _path)))
            {
                //xoa anh
                System.IO.File.Delete(Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "Upload", "ImageProducts", _path));
            }
        }
    }
}
